            ...
            <div class="row gutters-sm">
                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        @endif
                        <div class="mt-3">
                        <h4>{{ucfirst($student->username)}}</h4>
                        <div style="display: flex; flex-direction: column; justify-content: space-between">
                            <strong>bio:</strong>
                            <p class="text-secondary mb-1">hi, everyone</p>
                        </div>
                        <a class="btn btn-warning text-light" href="{{ route('students.edit', Auth::guard('student')->user()->rollno) }}">Edit Profile</a>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-secondary">
                            <span class="badge badge-secondary">Email Verified</span>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                        <h6 class="mb-0">Last Account Updated At</h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                            {{$student->updated_at}}
                        </div>
